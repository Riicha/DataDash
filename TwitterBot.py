...
Target_Hash_Tags = [  "#HarvardHealth","#WeightLoss","#Drug",'#Medicine','#inflammation','#hcsm','#digitalhealth',
                        ...
                        '#SelfCare','#KeepTalkingMH','#publichealth','#medicine','#SupportRadiopaedia','#AllTeachAllLearn','#patientcentric'
                    ]



# List of handles that we are monitoring
List_of_handles_to_monitor = ['@HarvardHealth','@katyperry','@BarackObama','@taylorswift13','@ladygaga',
'@TheEllenShow','@Cristiano','@jtimberlake','@BritneySpears','@ArianaGrande','@ddlovato']
